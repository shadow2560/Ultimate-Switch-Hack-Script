...
echo 1: Launch IPS_patch_creator ^(recommanded^)?
echo 2: Create the loader_patches?
echo 3: Create the FS_patches and ES_patches?
echo 4: Create the FS_patches?
echo 5: Create the ES_patches?
