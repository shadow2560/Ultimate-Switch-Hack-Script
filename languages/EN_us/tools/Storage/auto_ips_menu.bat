...
echo.
echo You must create the loader patches each time you update Atmosphere based on the "fusee-secondary.bin" file.
echo.
...
echo No "fusee-secondary.bin" file filled in, the script will stop.
goto:eof
