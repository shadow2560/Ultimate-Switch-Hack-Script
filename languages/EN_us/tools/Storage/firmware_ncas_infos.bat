...
:display_title
title NCAs infos extract %this_script_version% - Shadow256 Ultimate Switch Hack Script %ushs_version%
goto:eof

:intro
echo This script allows to obtain the NCAs infos for a firmware.
echo.
echo This is useful to, for example, identify an error on a console.
echo If the file "ncas_infos_output.txt" exists in the folder selected for extraction of the information it will be replaced.
echo.
echo You will have to choose the firmware to work on, an up to date keys file and a folder where the information will be extracted.
goto:eof
