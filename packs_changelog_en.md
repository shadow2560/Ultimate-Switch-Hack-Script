...
<li>Update DBI to version 902.</li>
<li>Update MissionControl to version 0.15.2.</li>
...
<li>Update Sys-patch.</li>
<li>Update Ultrahand-overlay to version 2.4.5.</li>
<li>Update uLaunch to version 1.2.4.</li>
</ul>
<h2>V631</h2>
<ul>
<li>Update LockSmith-RCM to version 0.12.1.</li>
<li>Update Cyberfoil to version 1.4.5.</li>
</ul>
<h2>V630</h2>
<ul>
<li>Update Ultrahand-overlay to version 2.4.4.</li>
<li>Update Sys-Botbase to version 2.5.</li>
<li>Update NXThemeInstaller to version 2.9.</li>
</ul>
<h2>V629</h2>
<ul>
<li>Update Ultrahand-nx-ovlloader to version 2.0.2.</li>
<li>Update Ultrahand-overlay to version 2.4.2.</li>
<li>Update Status-Monitor-Overlay to version 1.4.1.</li>
<li>Update SwitchWave to version 1.1.1.</li>
</ul>
<h2>V628</h2>
<ul>
<li>Update Sys-patch.</li>
<li>Update Sys-clk for the firmware 21.0.0.</li>
<li>Update Ultrahand-nx-ovlloader to version 2.0.1.</li>
...
<li>Update DBI to version 895.</li>
</ul>
<h2>V626</h2>
<ul>
...
<li>Update FPSLocker to version 3.3.2.</li>
</ul>
<h2>V623</h2>
<ul>
<li>Update Atmosphere to version 1.11.1.</li>
<li>Update Hekate to version 6.5.2.</li>
<li>Update LockSmith-RCM to version 0.11.1.</li>
<li>Update CyberFoil to version 1.4.3.</li>
<li>Update MissionControl to version 0.15.1.</li>
<li>Update Ldn-mitm to version 1.25.1.</li>
<li>Update Emuiibo to version 1.1.3.</li>
<li>Update Switch-ezremote-client to version 1.14.</li>
<li>Update MiiPort to version 0.1.2.</li>
<li>Update Salty-nx to version 1.7.5.</li>
<li>Update the patches files used by NXThemesInstaller.</li>
</ul>
<h2>V622</h2>
<ul>
...
<ul>
<li>Update NXDumpTool.</li>
<li>Update DBI to version 871.</li>
<li>Update CheckPoint to version 3.11.0.</li>
<li>Update SimpleModManager to version 2.1.4.</li>
<li>Update Ultrahand-overlay to version 2.2.9.</li>
<li>Update FPSLocker to version 3.3.1.</li>
</ul>
<h2>V620</h2>
<ul>
<li>Update CyberFoil to version 1.4.1.</li>
</ul>
<h2>V619</h2>
<ul>
<li>Remove the payloads Incognito-RCM and Lockpick-RCM, replaced by LockSmith-RCM.</li>
<li>Add the CyberFoil homebrew.</li>
<li>Add the Hekate-Toolbox homebrew by default in the Atmosphere's pack.</li>
<li>Update Atmosphere to version 1.10.2.</li>
<li>Update Hekate to version 6.5.1.</li>
<li>Update Sys-patch.</li>
<li>Update the patches files used by NXThemesInstaller.</li>
<li>Update Sphaira to version 1.0.0.</li>
<li>Update Reset-Parental-Controls-NX.</li>
<li>Update Linkalho.</li>
<li>Update SimpleModManager.</li>
<li>Update Awoo-Installer to version 1.3.6.</li>
<li>Update Goldleaf to version 1.2.0.</li>
<li>Update DBI to version 868.</li>
<li>Update NXDumpTool.</li>
<li>Update Haku33 to version 7.2.</li>
<li>Update Aio-switch-updater to version 2.23.3.</li>
<li>Update NXThemeInstaller to version 2.8.3.</li>
<li>Update Checkpoint to version 3.10.2.</li>
<li>Update JKSV to version 12/02/2025.</li>
<li>Update SimpleModDownloader to version 2.3.0.</li>
<li>Update nx-locale-switcher to version 1.1.4.</li>
<li>Update NXMP to version 0.9.3.</li>
<li>Update the Pemu emulators to version 7.1.</li>
<li>Update Flycast to version 2.6.</li>
<li>Update Battery_desync_fix_nx to version 1.5.1.</li>
<li>Update NX-Activity-Log to version 1.5.8.</li>
<li>Update MissionControl to version 0.14.2.</li>
<li>Update Sys-con to version 1.6.2.</li>
<li>Update Ldn-mitm to version 1.24.0.</li>
<li>Update Fizeau to version 2.8.2.</li>
<li>Update Sys-botbase to version 2.41.</li>
<li>Update Sys-tune to version 2.1.0.</li>
<li>Update Ulaunch to version 1.2.3.</li>
<li>Update Emuiibo to version 1.1.2.</li>
<li>Update Amiigo to version 2.4.1.</li>
<li>Update Ultrahand-nx-ovloader to version 2.0.0.</li>
<li>Update Ultrahand-overlay to version 2.2.7.</li>
<li>Update QuickMTP to version 1.6.0.</li>
<li>Update Status-monitor-overlay to version 1.3.2.</li>
<li>Update ovlSysmodules.</li>
<li>Update EdiZon-SE to version 3.8.37a.</li>
<li>Update EdiZon-overlay to version 1.0.14.</li>
<li>Update FastCFWswitch to version 1.3.2.</li>
<li>Update Salty-nx to version 1.7.4.</li>
<li>Update SaltyNX-Tool to version 1.1.1.</li>
<li>Update ReverseNX-RT to version 2.2.1.</li>
<li>Update FPSLocker to version 3.3.0.</li>
<li>Update the link of Retroarch for the version 1.22.0.</li>
</ul>
<h2>V618</h2>
<ul>
...
<li>Update Ultrahand-overlay to version 2.1.4.</li>
<li>Update MissionControl to version 0.13.6.</li>
<li>Update LDN_mitm to version 1.22.0.</li>
<li>Update Status-Monitor-Overlay to version 1.2.4.</li>
<li>Update EdiZon-overlay to version 1.0.11.</li>
<li>Update Salty-nx to version 1.5.5.</li>
<li>Update FPSLocker to version 3.0.3.</li>
</ul>
<h2>V616</h2>
<ul>
<li>Update Ultrahand-overlay to version 2.1.0.</li>
<li>Update Salty-nx to version 1.5.2.</li>
<li>Update FPSLocker to version 3.0.1.</li>
</ul>
<h2>V615</h2>
<ul>
<li>Update Salty-nx to version 1.5.0.</li>
<li>Update FPSLocker to version 3.0.0.</li>
</ul>
<h2>V614</h2>
<ul>
<li>Update Atmosphere to version 1.9.4.</li>
<li>Update Ultrahand-Overlay to version 2.0.1.</li>
<li>Update MissionControl to version 0.13.5.</li>
<li>Update LDN_mitm to version 1.21.0.</li>
<li>Update NXThemesInstaller to version 2.8.2.</li>
<li>Update Status-Monitor-Overlay to version 1.2.2.</li>
<li>Update Salty-nx to version 1.4.8.</li>
</ul>
<h2>V613</h2>
<ul>
<li>Update Status-Monitor-Overlay to version 1.2.1.</li>
<li>Update SaltyNX to version 1.4.6.</li>
<li>Update FPSLocker to version 2.4.0.</li>
</ul>
<h2>V612</h2>
<ul>
<li>Update Ldn-mitm to version 1.20.0.</li>
<li>Update Ultrahand-Overlay to version 2.0.0.</li>
<li>Update Salty-nx to version 1.4.5.</li>
<li>Update FPSLocker to version 2.3.1.</li>
</ul>
<h2>V611</h2>
<ul>
...
<li>Update MissionControl to version 0.13.3.</li>
<li>Update Ldn-mitm to version 1.19.0.</li>
<li>Update SimpleModDownloader to version 2.2.0.</li>
...
<li>Update Checkpoint to version 3.10.1.</li>
<li>Update NXDumpTool to the last pre-release version.</li>
<li>Update Ultrahand-Overlay to version 1.9.7.</li>
</ul>
<h2>V607</h2>
<ul>
...
<li>Update Sys-con to version 1.5.3.</li>
</ul>
<h2>V604</h2>
<ul>
...
<li>Update Ultrahand-Overlay to version 1.8.4.</li>
<li>Update FPSLocker to version 2.1.4.</li>
</ul>
<h2>V602</h2>
<ul>
<li>Update Status-Monitor-Overlay to version 1.1.9.</li>
<li>Update Salty-nx to version 1.2.5.</li>
<li>Update FPSLocker to version 2.1.3.</li>
</ul>
<h2>V601</h2>
<ul>
...
<li>Update Nxmp to version 0.9.1.</li>
<li>Update ULaunch to version 1.2.0.</li>
</ul>
<h2>V596</h2>
<ul>
...
<li>Update Sphaira to version 0.9.1.</li>
<li>replace the Tesla part by the Ultrahand part for the overlays management.</li>
<li>Update Checkpoint to version 3.10.0.</li>
<li>Update Nx-locale-switcher to version 1.1.3.</li>
<li>Update Sys-tune to version 3.0.0.</li>
<li>Update Status-Monitor-Overlay to version 1.1.8.</li>
<li>Update MissionControl to version 0.13.0.</li>
<li>Update Salty-nx to version 1.2.2.</li>
<li>Update FPSLocker to version 2.1.1.</li>
<li>Update the link of Retroarch for the version 1.21.0.</li>
<li>Update the patches files used by NXThemesInstaller.</li>
</ul>
<h2>V595</h2>
<ul>
<li>Update ULaunch to version 1.1.0.</li>
<li>Update Switch-ezremote-client to version 1.13.</li>
</ul>
<h2>V594</h2>
<ul>
<li>Update Switch-ezremote-client to version 1.12.</li>
<li>Update Vgedit to version 2.2.1.</li>
<li>Update MGBA to version 0.10.5.</li>
</ul>
<h2>V593</h2>
<ul>
<li>Update Sys-con to version 1.5.1.</li>
</ul>
<h2>V592</h2>
<ul>
<li>Update TinWoo to version 1.0.27.</li>
<li>Update Flycast to version master 3114344.</li>
</ul>
<h2>V591</h2>
<ul>
...
<h2>V589</h2>
<ul>
<li>Add the homebrew Sphaira.</li>
<li>Add the homebrew and the module Ftpsrv.</li>
<li>Update Status-Monitor-Overlay to version 1.1.7a.</li>
<li>Update Sys-con to version 1.5.0.</li>
<li>Update Switch-ezremote-client to version 1.08.</li>
<li>Update the link of Retroarch for the version 1.20.0.</li>
<li>Delete ScummVM.</li>
<li>Update Salty-nx to version 1.2.0.</li>
<li>Update NXFPS to version 2.1.0.</li>
<li>Remove the  configuration files for FPSLocker.</li>
</ul>
<h2>V588</h2>
<ul>
<li>Update Sys-patch.</li>
...
<li>Update MGBA to version 0.10.4.</li>
<li>Update Tinfoil to version 19.0_V1.</li>
...
<h2>V586</h2>
<ul>
<li>Add the homebrew Firmware-Dumper.</li>
<li>Add the homebrew SwitchWave.</li>
<li>Update Atmosphere to version 1.8.0-prerelease.</li>
<li>Update Hekate to version 6.2.2.</li>
<li>Update Sys-patch.</li>
<li>Update Ovl-menu.</li>
<li>Update Fizeau to version 2.6.0.</li>
<li>Update Status-Monitor-Overlay to version 1.1.4.</li>
<li>Update Sys-CLK to version 2.0.1.</li>
<li>Update MissionControl to version 0.12.0.</li>
<li>Update Sys-con to version 1.4.2.</li>
...
<li>Update FPSLocker to version 2.0.3.</li>
</ul>
<h2>V585</h2>
<ul>
<li>Update Salty-nx to version 0.9.3.</li>
</ul>
<h2>V584</h2>
<ul>
<li>Update the Picofly  firmware  to version 2.80.</li>
<li>Update Sys-con to version 1.4.1.</li>
<li>Update Fizeau to version 2.5.5.</li>
</ul>
<h2>V583</h2>
<ul>
...
<li>Update TinWoo to version 1.0.26.</li>
</ul>
<h2>V581</h2>
<ul>
...
<li>Update Haku33 to version 6.0.</li>
...
<h2>V538</h2>
<ul>
<li>Update Haku33 to version 5.1.</li>
...
<h2>V83</h2>
<ul>
<li>Update Atmosphere to the latest version of the Github in the Atmosphere and Kosmos packs, compiled by myself. Warning, this version of Atmosphere does not yet suport firmware 7.0.0.0.</li>
...
<li>Update "nogc" patches for the Atmosphere package (patch suport for the 7.0.0 firmware but the CFW does not yet suport this firmware in a simple way). </li>
</ul>
<h2>V79</h2>
<ul>
