...
for i in range(1,len(sys.argv), 1):
	currArg = sys.argv[i]
	if currArg == '-k' or currArg == '--keyset':
		sys.argv[i+1] = os.path.abspath(sys.argv[i+1])
		break

execution_dir=os.path.abspath(os.curdir)
...
if __name__ == '__main__':
	try:
		...
		parser.add_argument('-k', '--keyset', help='Set keyset file path')
		...
		# Must make the paths relative working on all params
		# args.argument=os.path.abspath(argument)
		# os.chdir(os.path.dirname(os.path.abspath(__file__)))
